		...
		<div className='flex flex-col justify-center py-8 sm:px-6 lg:px-8 '>
			...
			>
				<h2 className="py-2 text-center text-4xl font-bold text-orange-400">
                    Create y<span className="relative inline-block pb-1">
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-white/30 backdrop-blur-md  border border-gray-200 rounded-md shadow-sm
									 placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm text-black'
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-white/30 backdrop-blur-md
									 border-gray-200 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm text-black'
									placeholder='••••••••'
								/>
							</div>
						</div>
