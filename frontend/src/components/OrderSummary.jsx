...
const stripePromise = loadStripe("pk_test_51RN61VFoeeppxBioGjKpwTOU1vA3MdETrpgAdtT4JMea2RVH3ccGm9uFdvOU8kCTlAjanmVY3b7BXefud3GBNw0X007U2gJPC1");
...
const OrderSummary = () => {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border  bg-white p-4 shadow-lg sm:p-6'
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					<dl className='flex items-center justify-between gap-4'>
						...
						<dd className='text-base font-medium text-red-500'>₹{formattedSubtotal}</dd>
					</dl>
